      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-4 text-center">
          <div className="space-y-8">
            ...
            <h2 className="text-[100px] md:text-[100px] leading-none text-dotted text-center">
              software project manager
            </h2>
            <p className="max-w-2xl mx-auto text-gray-400 text-lg">
              Professional with 6+ years of experience in Agile software
              development, API integrations, and cloud infrastructure. Focused
              on backlog management and stakeholder collaboration.
            </p>
